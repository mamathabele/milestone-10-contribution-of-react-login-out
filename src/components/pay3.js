      ...
      <div className="content">
        ...
        <div className="form1">
          ...
          <div>
            ...
            <Row>
              <Col span={6} pull={18}>
                <h5 className="title4">Select a Payment Method</h5>
              </Col>
            </Row>
            <div className="box">
            ...
            <div className="box" style={{ marginTop: 10 }}>
              <Row>
                <Col span={6}>
                  <img src={wallet} className="imge2" />
                </Col>
                <Col span={6} style={{ marginTop: 5 }}>
                  <Link
                    to="/"
                    style={{ color: "#0d86e9", paddingRight: 28 }}
                    activeStyle={{ color: "red" }}
                  >
                    Wallets
                  </Link>
            ...
            <div className="box" style={{ marginTop: 10 }}>
              <Row>
                <Col span={6}>
                  <img src={paylater} className="imge2" />
                </Col>
                <Col span={6} style={{ marginTop: 5 }}>
                  <Link
                    to="/"
                    style={{ color: "#0d86e9", paddingRight: 20 }}
                    activeStyle={{ color: "red" }}
                  >
                    Pay Later
                  </Link>
